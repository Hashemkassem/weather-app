...
// in last_weather_app/test/helper/test_helper.dart.
...
import 'package:last_weather_app/core/error/failure.dart' as _i7;
import 'package:last_weather_app/data/models/weather_model.dart' as _i3;
import 'package:last_weather_app/data/source/remote_data_source.dart' as _i9;
import 'package:last_weather_app/domain/entities/weather.dart' as _i8;
import 'package:last_weather_app/domain/repositories/weather_repo.dart' as _i4;
...
class MockWeatherRepo extends _i1.Mock implements _i4.WeatherRepo {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntities>> getCurrentWeather(
          String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
        ...
        returnValue:
            _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntities>>.value(
                _FakeEither_0<_i7.Failure, _i8.WeatherEntities>(
          this,
          Invocation.method(
            #getCurrentWeather,
            [cityName],
      ...
      ) as _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntities>>);
}
...
class MockGetCurrentWeatherUseCase extends _i1.Mock
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i8.WeatherEntities>> execute(
          String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
